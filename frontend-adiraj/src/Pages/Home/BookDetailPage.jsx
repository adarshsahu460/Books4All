...
const BookDetailPage = () => {
  ...
  const handleBuyNow = async () => {
    ...
    const response = await axios.post('http://localhost:3005/api/client/books',{
  ...
  useEffect(() => {
    const fetchBookDetails = async () => {
      try {
        const response = await axios.get(`http://localhost:3005/api/request/by-isbn?isbn=${id}`);
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/5">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <input type = "text" placeholder='Enter Quantity' onChange={(e)=>{
